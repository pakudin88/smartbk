...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Form Edit Tahun Ajaran</h5>
    </div>
    <div class="card-body">
        <form action="<?= base_url('school-years/update/' . $schoolYear['id']) ?>" method="post">
            <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= $validation->hasError('nama_tahun_ajaran') ? 'is-invalid' : '' ?>" 
                               id="nama_tahun_ajaran" name="nama_tahun_ajaran" 
                               value="<?= old('nama_tahun_ajaran', $schoolYear['nama_tahun_ajaran']) ?>" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= $validation->hasError('semester') ? 'is-invalid' : '' ?>" 
                            ...
                            <option value="Ganjil" <?= old('semester', $schoolYear['semester']) == 'Ganjil' ? 'selected' : '' ?>>Semester Ganjil</option>
                            <option value="Genap" <?= old('semester', $schoolYear['semester']) == 'Genap' ? 'selected' : '' ?>>Semester Genap</option>
                        </select>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= $validation->hasError('tahun_mulai') ? 'is-invalid' : '' ?>" 
                               ...
                               value="<?= old('tahun_mulai', $schoolYear['tahun_mulai']) ?>" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= $validation->hasError('tahun_selesai') ? 'is-invalid' : '' ?>" 
                               ...
                               value="<?= old('tahun_selesai', $schoolYear['tahun_selesai']) ?>" 
                               min="2020" max="2030" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control <?= $validation->hasError('start_date') ? 'is-invalid' : '' ?>" 
                               ...
                               value="<?= old('start_date', $schoolYear['start_date']) ?>" required>
                        <div class="invalid-feedback">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control <?= $validation->hasError('end_date') ? 'is-invalid' : '' ?>" 
                               ...
                               value="<?= old('end_date', $schoolYear['end_date']) ?>" required>
                        <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <select class="form-select <?= $validation->hasError('is_active') ? 'is-invalid' : '' ?>" 
                    ...
                    <option value="1" <?= old('is_active', $schoolYear['is_active']) == '1' ? 'selected' : '' ?>>Aktif</option>
                    <option value="0" <?= old('is_active', $schoolYear['is_active']) == '0' ? 'selected' : '' ?>>Nonaktif</option>
                </select>
                <div class="invalid-feedback">
