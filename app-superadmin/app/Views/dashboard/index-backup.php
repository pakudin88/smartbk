<?php
// Simple dashboard view yang pasti jalan
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Sidebar */
        .sidebar {
            width: 260px; background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%);
            color: white; position: fixed; height: 100vh; overflow-y: auto; z-index: 1000;
            box-shadow: 2px 0 10px rgba(0,0,0,0.1); transition: all 0.3s ease;
        }
        ...
        .sidebar-header h3 { color: #ecf0f1; font-size: 1.4rem; font-weight: 600; margin-bottom: 5px; }
        .sidebar-header p { color: #bdc3c7; font-size: 0.9rem; }
        .sidebar-nav { padding: 20px 0; }
        .nav-link {
            display: flex; align-items: center; padding: 15px 25px; color: #bdc3c7;
        ...
        .nav-link:hover { 
            ...
            border-left-color: #3498db; padding-left: 30px; 
        }
        .nav-link.active { 
            background: rgba(52, 152, 219, 0.2); color: #3498db; 
            border-left-color: #3498db; font-weight: 500; 
        }
        .nav-icon { margin-right: 12px; font-size: 1.1rem; width: 20px; text-align: center; }
        ...
        .sidebar-toggle {
            background: #667eea; color: white; border: none; padding: 10px 12px;
            border-radius: 6px; cursor: pointer; font-size: 1rem; transition: all 0.3s ease;
        }
        .sidebar-toggle:hover { background: #5a6fd8; transform: scale(1.05); }
        .page-title { font-size: 1.5rem; font-weight: 600; color: #2c3e50; margin: 0; }
        .user-menu { display: flex; align-items: center; gap: 15px; }
        .user-info { text-align: right; }
        .user-name { font-weight: 600; color: #2c3e50; font-size: 0.95rem; }
        .user-role { font-size: 0.8rem; color: #7f8c8d; }
        .logout-btn {
        ...
        .welcome-title { font-size: 2.2rem; font-weight: 700; margin-bottom: 10px; }
        .welcome-subtitle { font-size: 1.1rem; opacity: 0.9; margin: 0; }
        ...
        .quick-actions {
            background: white; padding: 30px; border-radius: 12px;
            box-shadow: 0 5px 20px rgba(0,0,0,0.1); border: 1px solid #e9ecef;
        }
        .section-title {
            font-size: 1.4rem; font-weight: 600; color: #2c3e50; margin-bottom: 25px;
        ...
        .action-card {
            background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;
            padding: 25px; border-radius: 10px; text-decoration: none; text-align: center;
            transition: all 0.3s ease; border: none; box-shadow: 0 5px 15px rgba(0,0,0,0.1);
        }
        .action-card:hover {
            transform: translateY(-3px); box-shadow: 0 10px 25px rgba(0,0,0,0.2); color: white;
        }
        .action-icon { font-size: 2rem; margin-bottom: 10px; display: block; }
        .action-title { font-size: 1.1rem; font-weight: 600; margin: 0; }
        
        .success-message {
            background: #d4edda; color: #155724; padding: 15px 20px; border-radius: 8px;
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="/schools" class="nav-link">
                    <span class="nav-icon">🏫</span> Kelola Sekolah
                </a>
                <a href="/classes" class="nav-link">
                    <span class="nav-icon">🎓</span> Kelola Kelas
                </a>
        ...
        <div class="main-content" id="mainContent">
            ...
            <main class="content">
                ...
                <div class="success-message">
                    ✅ Dashboard berhasil dimuat! CodeIgniter 4 berjalan dengan baik.
                </div>
                
                <!-- Welcome Section -->
                <section class="welcome-section">
                    <h2 class="welcome-title">Selamat Datang, <?= htmlspecialchars($user_name) ?>!</h2>
