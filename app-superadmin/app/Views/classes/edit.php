                        ...
                        <select class="form-select <?= $validation->hasError('sekolah_id') ? 'is-invalid' : '' ?>" 
                            ...
                            <?php foreach ($schools as $school): ?>
                                <option value="<?= $school['id'] ?>" 
                                        <?= old('sekolah_id', $class['sekolah_id']) == $school['id'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= $validation->hasError('tingkat') ? 'is-invalid' : '' ?>" 
                            ...
                            <?php for ($i = 1; $i <= 12; $i++): ?>
                                <option value="<?= $i ?>" 
                                        <?= old('tingkat', $class['tingkat']) == $i ? 'selected' : '' ?>>
                                    Kelas <?= $i ?>
                                </option>
                            <?php endfor; ?>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= $validation->hasError('jurusan') ? 'is-invalid' : '' ?>" 
                               id="jurusan" name="jurusan" value="<?= old('jurusan', $class['jurusan']) ?>" 
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= $validation->hasError('kapasitas') ? 'is-invalid' : '' ?>" 
                               id="kapasitas" name="kapasitas" value="<?= old('kapasitas', $class['kapasitas']) ?>" min="1" required>
                        <div class="invalid-feedback">
