...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?= base_url('positions/update/' . $jabatan['id']) ?>" method="POST">
            <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= (isset($validation) && $validation->hasError('kategori')) ? 'is-invalid' : '' ?>" 
                            ...
                            <option value="guru_mapel" <?= (old('kategori', $jabatan['kategori']) == 'guru_mapel') ? 'selected' : '' ?>>Guru Mata Pelajaran</option>
                            <option value="kepala_sekolah" <?= (old('kategori', $jabatan['kategori']) == 'kepala_sekolah') ? 'selected' : '' ?>>Kepala Sekolah</option>
                            <option value="wakil_kepala_sekolah" <?= (old('kategori', $jabatan['kategori']) == 'wakil_kepala_sekolah') ? 'selected' : '' ?>>Wakil Kepala Sekolah</option>
                            <option value="guru_bk" <?= (old('kategori', $jabatan['kategori']) == 'guru_bk') ? 'selected' : '' ?>>Guru BK</option>
                            <option value="admin" <?= (old('kategori', $jabatan['kategori']) == 'admin') ? 'selected' : '' ?>>Admin</option>
                            <option value="staff" <?= (old('kategori', $jabatan['kategori']) == 'staff') ? 'selected' : '' ?>>Staff</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= (isset($validation) && $validation->hasError('departemen')) ? 'is-invalid' : '' ?>" 
                            ...
                            <option value="akademik" <?= (old('departemen', $jabatan['departemen']) == 'akademik') ? 'selected' : '' ?>>Akademik</option>
                            <option value="administrasi" <?= (old('departemen', $jabatan['departemen']) == 'administrasi') ? 'selected' : '' ?>>Administrasi</option>
                            <option value="bimbingan_konseling" <?= (old('departemen', $jabatan['departemen']) == 'bimbingan_konseling') ? 'selected' : '' ?>>Bimbingan Konseling</option>
                            <option value="kepala_sekolah" <?= (old('departemen', $jabatan['departemen']) == 'kepala_sekolah') ? 'selected' : '' ?>>Kepala Sekolah</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= (isset($validation) && $validation->hasError('level')) ? 'is-invalid' : '' ?>" 
                            ...
                            <option value="pimpinan" <?= (old('level', $jabatan['level']) == 'pimpinan') ? 'selected' : '' ?>>Pimpinan</option>
                            <option value="koordinator" <?= (old('level', $jabatan['level']) == 'koordinator') ? 'selected' : '' ?>>Koordinator</option>
                            <option value="pelaksana" <?= (old('level', $jabatan['level']) == 'pelaksana') ? 'selected' : '' ?>>Pelaksana</option>
                        </select>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control <?= (isset($validation) && $validation->hasError('deskripsi')) ? 'is-invalid' : '' ?>" 
                          ...
                          placeholder="Deskripsi tugas dan tanggung jawab jabatan..."><?= old('deskripsi', $jabatan['deskripsi']) ?></textarea>
