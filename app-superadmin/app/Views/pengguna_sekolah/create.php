        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">
                                <i class="fas fa-user-plus"></i> Tambah Pengguna Sekolah
                            </h4>
                            <p class="card-text mb-0">Tambah petugas baru untuk sistem</p>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('pengguna-sekolah/store') ?>" method="post">
                        <?= csrf_field() ?>
